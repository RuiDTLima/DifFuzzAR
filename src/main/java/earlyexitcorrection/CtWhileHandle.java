...
class CtWhileHandle {
    ...
    static boolean handleWhile(Factory factory,
        ...
        CtBlock<?> newWhileBody = EarlyExitVulnerabilityCorrection.handleStatements(factory, body.iterator(), returnsIterator, returnVariable, returnElement, afterWhileReturn);
