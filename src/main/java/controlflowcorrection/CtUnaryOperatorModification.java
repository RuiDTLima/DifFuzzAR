...
class CtUnaryOperatorModification {
     ...
     * @return						Returns an array of blocks where in the first index is the original unary operator
     * 								and in the second index is the newly created unary operator.
     */
    static CtBlock<?>[] modifyUnaryOperator(CtElement element,
                                            Factory factory,
