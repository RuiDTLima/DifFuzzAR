...
public class CtLoopModification {
     ...
     * @return					Returns an array of blocks where in the first index is the loop body with slight
     * 							modifications and in the second index is a completely changed loop body.
     */
    static CtBlock<?>[] traverseStatement(CtStatement statement,
        ...
        CtBlock<?> body = (CtBlock<?>) loopStatement.getBody();
