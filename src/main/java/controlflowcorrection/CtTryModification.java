...
public class CtTryModification {
	 ...
	 * @return	Returns an array of blocks where in the first index is the original body of the 'try' statement with
	 * slight modifications and in the second index a completely modified version of the body of the 'try' statement.
	 */
