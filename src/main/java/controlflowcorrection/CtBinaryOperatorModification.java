...
class CtBinaryOperatorModification {
    ...
    /**
     * The method where a binary operator is modified. Here each hand of the binary operator will be modified depending
     * on their type of operation, as it stands for the left hand it will be modified if the operand is a 'variable read'
     * or an 'array read', while in the right hand it will be modified only if the operand is a 'variable read'.
     ...
     */
    static CtBinaryOperator<Boolean> modifyBinaryOperator(Factory factory,
